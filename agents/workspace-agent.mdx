...
<Note>
Charts require your organization's analytics instance to be connected first — see [Connect your analytics engine](/guides/analytics#connect-your-analytics-engine). Until then the agent will point you to Settings → Connections instead of rendering.
</Note>
