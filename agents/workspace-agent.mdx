...
<Warning>
  **Secrets are never echoed.** If your synced source or records contain credentials — API keys, tokens, passwords, client secrets — the agent reports _where_ they live and flags them as a security risk, but never prints the full value in its answer or inside a code snippet. It treats your documentation as leads to verify, not proof: for questions about how your org is configured today, it confirms against your live org and metadata before asserting.
</Warning>
