...
The catalog attempts to discover metadata available to the connected Salesforce account. API permissions, package restrictions, and retrieval failures can limit coverage. Each connection's **Ingest settings** page scopes AI search, grounding, and the dependency graph:
...
| [Dependency graph](/guides/salesforce-graph) | Interactive usages, dependencies, paths, and source evidence across metadata |
