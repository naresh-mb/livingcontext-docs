...
<Steps>
  ...
  <Step title="Connect Salesforce (optional)">
    Link a Salesforce org so agents can ground documentation in your actual metadata. Salesforce uses **your own Connected App**: an Administrator first adds its consumer key and secret on [Connections](/integrations/salesforce), after which **Connect Sandbox** and **Connect Production** appear — connect as many orgs as you need. You can skip this entirely and add it later.
  </Step>
</Steps>
