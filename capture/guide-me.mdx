...
<Steps>
  <Step title="Pick a guide">
    Open the side panel's **Guide** tab — it lists every published guide that has merged into your docs — and click **Start guide**. The [assistant](/capture/ask-docs) can also suggest a guide and start it for you when your question is a "how do I…".
  </Step>
