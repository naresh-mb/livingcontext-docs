...
- **Search** — find any object by name and jump to it.
...
- Viewing schema diagrams requires **documentation read access** — the same permission that gates the docs and analytics surfaces (see [Roles and permissions](/admin/roles-and-permissions)).
